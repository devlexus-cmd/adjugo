"""sync schéma — pièces administratives des co-traitants (groupement)

Crée `contribution_pieces`. Corps générique idempotent (create_all + ADD COLUMN
manquantes). Non destructif.
