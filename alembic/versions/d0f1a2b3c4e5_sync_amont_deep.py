"""sync schéma — colonnes profondes veille amont (domaine, phase, echeance_ao, financement, maturite)

Passe de synchro idempotente (create_all + ADD COLUMN manquantes) pour les colonnes
ajoutées au modèle Signal (veille amont approfondie). Non destructif.

Revision ID: d0f1a2b3c4e5
