"""sync schéma — espace co-traitance (co_spaces, co_members)

Passe de synchro idempotente (create_all + ADD COLUMN manquantes) pour les tables
de l'espace co-traitance partagé (Merged Brain). Non destructif.

Revision ID: e1a2b3c4d5f6
Revises: d0f1a2b3c4e5
