"""sync schéma — chiffrage (tarifs Company + estimate Project)

Passe de synchro idempotente (create_all + ADD COLUMN manquantes). Non destructif.
Ajoute companies.day_rates / distance_threshold_km / distance_surcharge_pct et
projects.estimate.
