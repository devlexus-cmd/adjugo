"""sync schéma — contributions co-traitant (co-construction CaaS) + rôle d'invitation

Crée `project_contributions` et ajoute `project_invites.role` / `.can_contribute`.
Corps générique idempotent (create_all + ADD COLUMN manquantes). Non destructif.
