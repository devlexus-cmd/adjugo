...
- utiliser le Service conformément à la loi, aux présentes CGV et à sa destination ;
- ne téléverser que des documents qu'il est en droit d'utiliser et de traiter (notamment les DCE et documents d'entreprise) ;
- vérifier et valider tout document ou analyse avant soumission à un acheteur public ;
- ne pas tenter de contourner les mesures de sécurité, ni de surcharger ou détourner le Service.
